...
train_data, stoi, itos, vocab_size = load_data('/kaggle/input/input-childspeech-testset-txt/input_childSpeech_testSet.txt')
...
test_loss = test_model(model, '/kaggle/input/input-childspeech-testset-txt/input_childSpeech_testSet.txt')
